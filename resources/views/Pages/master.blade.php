    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index2.html" class="logo">
                ...
                <span class="logo-lg"><b>Klinik</b>Asla</span>
            </a>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-bed"></i>
                            <span>Registrasi</span> <i class="fa fa-angle-left pull-right"></i>
                            <span class="label label-primary pull-right">5</span>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="{{ url('/registrasi') }}"><i class="fa fa-circle-o"></i> Registrasi</a></li>
                            <li><a href="{{ url('/data-sosial') }}"><i class="fa fa-circle-o"></i> Data Sosial</a>
                            </li>
                        </ul>
                    </li>
                    {{-- <li>
          <a href="pages/widgets.html">
            ...
            <small class="label pull-right bg-green">new</small>
                    ...
                    <li class="active treeview">
                        <a href="{{ url('/antrian') }}">
                            <i class="fa fa-dashboard"></i> <span>Antrian</span>
                            {{-- <i class="fa fa-angle-left pull-right"></i> --}}
                        </a>
                    </li>
                    <li class="active treeview">
                        <a href="{{ url('') }}">
                            <i class="fa fa-dashboard"></i> <span>Tindakan Medis</span>
                            {{-- <i class="fa fa-angle-left pull-right"></i> --}}
                        </a>
                    </li>
